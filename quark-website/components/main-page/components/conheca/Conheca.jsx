    ...
    <>
      <div className={styles.container}>
        ...
        <div className={styles.text}>
          ...
          <p>
            A Quark é uma plataforma que nasceu a partir de um problema global:
            a falta do desenvolvimento de Soft Skills na trajetória curricular
            dos jovens. Só no Brasil, mais de 70% dos jovens não se sentem
            preparados para enfrentar o mercado de trabalho (Instituto
            Millenium).
          </p>
          <p>
          ...
          <button onClick={() => setForms(!isFormsOpen)}>
            Fale com a gente
          </button>
        </div>
      </div>
